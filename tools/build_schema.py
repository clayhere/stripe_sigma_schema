...
def main() -> int:
    ...
    schema = {
        ...
        "warning": "Column lists are complete only where columns_complete is true, and coverage is not guaranteed current — Stripe can change the Sigma schema at any time. Run tools/verify_against_sigma.py to confirm and extend this file.",
        "confidence_levels": {
